 ...
 * Description: Accessible, offline-capable, release-hardened Decision Studio with recovery snapshots, migration gates, public APIs, institutional integration, outcomes monitoring, publications, Decision Packs, collaboration, scenarios, governance, and typed platform evidence.
 * Version: 1.16.0
...
class Sustainable_Catalyst_Decision_Studio {
    ...
    const BUILD_FINGERPRINT = 'scds-v1.16.0-accessibility-offline-release-hardening';
    const SOURCE_COMMIT = 'release-v1.16.0';
    ...
    public function render_decision_studio_shortcode($atts = []) {
        ...
        if (!in_array($mode, ['full', 'landing', 'demo', 'workflow', 'readiness', 'governance', 'room', 'packs', 'publication', 'outcomes', 'integration', 'hardening', 'project-intake', 'scorecard', 'risk', 'scenario', 'handoff', 'packets', 'export', 'report', 'drawer', 'compact'], true)) {
            $mode = 'full';
        }
        ...
        wp_localize_script('scds-decision-studio', 'SCDSDecisionStudio', [
            ...
            'storageKey' => 'scds_saved_decision_packets_v1_16_0',
    ...
    private function public_landing_template() {
        return [
            ...
            'features' => [
                ...
                ['title'=>'Decision Packet workspace','description'=>'Use scds-decision-packet/1.9 to hold platform handoffs, evidence, assumptions, scenarios, experiments, calculations, entities, provenance, and audit records.'],
    ...
    private function render_panel_workflow($mode) { ?>
        <section class="scds-panel" data-scds-panel="workflow">
            ...
            <div class="scds-note"><strong>v1.12.0 contract:</strong> <code>scds-platform-artifact/1.0</code> is additive. Legacy Canvas, Data, Analytics R, Global Impact, Narrative Risk, Finance, and Grit JSON exports remain importable through compatibility adapters.</div>
    ...
    private function render_panel_release_hardening($mode) { ?>
        <section class="scds-panel" data-scds-panel="hardening">
            ...
            <div class="scds-form-grid">
                ...
                <label>Migration profile JSON<textarea rows="6" data-scds-hardening-migration>{"from_schema":"scds-decision-packet/1.8","to_schema":"scds-decision-packet/1.9"}</textarea></label>
...
SCDS_OPENAI_MODEL=&lt;your-model&gt;</pre>';
    ...
    private function release_hardening_template() {
        return [
            ...
            'supported_migrations'=>['from_packet_schemas'=>array_map(function($n){return 'scds-decision-packet/1.'.$n;},range(0,8)),'to_packet_schema'=>'scds-decision-packet/1.9','strategy'=>'additive_defaulting'],
    ...
    private function decision_packet_template() {
        return [
            'packet_version'=>self::VERSION,'decision_packet_schema'=>'scds-decision-packet/1.9','decision_pack_schema'=>self::DECISION_PACK_SCHEMA,'decision_pack_application_schema'=>self::DECISION_PACK_APPLICATION_SCHEMA,
            'publication_studio_schema'=>self::PUBLICATION_STUDIO_SCHEMA,
            'outcome_monitoring_schema'=>self::OUTCOME_MONITORING_SCHEMA,
            'reassessment_event_schema'=>self::REASSESSMENT_EVENT_SCHEMA,
            'decision_registry_schema'=>self::DECISION_REGISTRY_SCHEMA,
