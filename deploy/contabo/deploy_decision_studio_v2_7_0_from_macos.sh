...
BACKEND="$DOWNLOADS/sustainable-catalyst-decision-studio-backend-v2.7.0.zip"
UPGRADER="$DOWNLOADS/upgrade_decision_studio_backend_v2_7_0_contabo.sh"
...
ssh -i "$KEY" -o IdentitiesOnly=yes "$HOST" 'chmod +x /tmp/upgrade_decision_studio_backend_v2_7_0_contabo.sh && /tmp/upgrade_decision_studio_backend_v2_7_0_contabo.sh /tmp/sustainable-catalyst-decision-studio-backend-v2.7.0.zip'
echo "=== PUBLIC VERIFY ==="
