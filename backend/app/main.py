...
APP_VERSION = "2.8.0"
BUILD_FINGERPRINT = os.getenv("SCDS_BUILD_FINGERPRINT", "scds-v2.8.0-decision-graph-dependency-mapping")
SOURCE_COMMIT = os.getenv("SCDS_SOURCE_COMMIT", "release-v2.8.0")
