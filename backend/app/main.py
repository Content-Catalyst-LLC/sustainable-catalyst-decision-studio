...
APP_VERSION = "2.4.0"
BUILD_FINGERPRINT = os.getenv("SCDS_BUILD_FINGERPRINT", "scds-v2.4.0-uncertainty-sensitivity-confidence")
SOURCE_COMMIT = os.getenv("SCDS_SOURCE_COMMIT", "release-v2.4.0")
