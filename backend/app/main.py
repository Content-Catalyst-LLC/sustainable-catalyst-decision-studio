...
APP_VERSION = "2.2.0"
BUILD_FINGERPRINT = os.getenv("SCDS_BUILD_FINGERPRINT", "scds-v2.2.0-evidence-source-bundles")
SOURCE_COMMIT = os.getenv("SCDS_SOURCE_COMMIT", "release-v2.2.0")
