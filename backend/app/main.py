...
APP_VERSION = "2.3.1"
BUILD_FINGERPRINT = os.getenv("SCDS_BUILD_FINGERPRINT", "scds-v2.3.1-criteria-alternatives-tradeoff-matrix")
SOURCE_COMMIT = os.getenv("SCDS_SOURCE_COMMIT", "release-v2.3.1")
