...
CONSUMER_CONTRACT = 'sc-energy-runtime-decision-studio-handoff/1.0'
HANDOFF_SCHEMA = "sc-energy-runtime-handoff/1.0"
RECEIPT_SCHEMA = "sc-energy-runtime-consumer-receipt/1.0"
EXPECTED_SECTIONS = ['identity', 'decision', 'economics', 'sustainability_indicators', 'global_context', 'uncertainty', 'provenance', 'review']
