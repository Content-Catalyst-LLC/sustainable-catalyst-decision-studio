# Decision Studio v1.6.0 — Saved Decision Packets and Export Center

Decision Studio v1.6.0 adds a persistence and export layer around the Decision Packet workflow.
